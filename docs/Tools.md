...
This section acts as a guide to the most useful electrical tools and components for FRC teams. Whether you are upgrading your current toolkit or starting from scratch, this page is a good place to begin.

## Ferrules

### Ferrule Crimper

- Budget pick: [iWiss Square Ferrule Crimper](https://wcproducts.com/products/iwiss-tools)

  ![iWISS Square Ferrule Crimping Tool](assets/Tools/iWissSquareFerruleCrimper.png)

- Quality pick: [Knipex 97 53 04](https://www.digikey.com/en/products/detail/knipex-tools-lp/97-53-04/10451678)

  ![Knipex 97 53 04](assets/Tools/Knipex_97-53-04.png)
...
| --- | --- | --- | --- | --- |
| 8AWG | 12mm | AW100012 | Powering high-current devices | [FerrulesDirect](https://www.ferrulesdirect.com/collections/insulated-wire-ferrules/products/aw100012) |
...
!!! info
    ...
    12mm pin-length ferrules are better for inserting a wire into power distribution hardware such as a PDH, PDP, or AMPD, while 8mm ferrules are better in Weidmuller terminals.

## MolexSL

### Molex Tool

- DigiKey: [Purchase Link](https://www.digikey.com/en/products/detail/molex/0638118700/1832243)

  ![Molex Tool](assets/Tools/Molex_Tool.png)

- Mouser: [Purchase Link](https://www.mouser.com/ProductDetail/Molex/63811-8700?qs=kaOkW4VzSzcoF%2FkuYEQlmw%3D%3D)

  ![Molex Tool](assets/Tools/Molex_Tool.png)

- FIRST Choice: Historically, the Molex tool has been available there for free through team credits.
...
- Budget pick: [iWiss Powerpole Crimper](https://wcproducts.com/products/iwiss-tools)

  ![iWiss Powerpole Crimper](assets/Tools/iWissPowerpoleCrimpers.png)

- Quality pick: [Powerwerx Powerpole Crimper](https://powerwerx.com/tricrimp-powerpole-connector-crimping-tool)
...
- Budget pick: [Jonard Tools CST-1900](https://www.amazon.com/gp/product/B0069627PA?linkId=0b213ec3eef054b7c26d5fc4e0522e33&language=en_US)

  ![Jonard Tools CST-1900](assets/Tools/Jonard_CST-1900.png)

- Quality pick: [Knipex 16 30 135](https://www.digikey.com/en/products/detail/knipex-tools-lp/16-30-135-SB/10451750)

  ![Knipex 16 30 135](assets/Tools/Knipex_16-30-135.png)

### Non-Battery

- Budget pick: [Knipex 12 62 180](https://www.digikey.com/en/products/detail/knipex-tools-lp/12-62-180/10451692)

  ![Knipex 12 62 180](assets/Tools/Knipex_12-62-180.png)

- Quality pick: [AutomationDirect DN-WS](https://www.automationdirect.com/adc/shopping/catalog/tools_-a-_test_equipment/pliers_-a-_cutting_tools/wire_-a-_cable_stripping_tools/dn-ws)

  ![AutomationDirect DN-WS](assets/Tools/AutomationDirect_DN-WS.png)

## Flush Cutters

- Budget pick: [iWiss Diagonal Flush Cutters](https://wcproducts.com/products/iwiss-tools)

  ![iWiss Diagonal Flush Cutters](assets/Tools/iWissFlushCutters.png)

- Quality pick: [Knipex 78 91 125](https://www.knipex-tools.com/products/electronics-pliers/knipex-super-knips-electronics-pliers/electronics-super-knips/7891125)
...
|  | Jacket CAN wire (comes in black, white, or gray) | [WCP](https://wcproducts.com/products/wire) |
...
!!! info
    ...
    Continuous-flex CAN wire is useful in mechanisms that move a lot, such as a turret or elevator.